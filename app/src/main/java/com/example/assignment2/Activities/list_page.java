...
//    }
    ...
    //When the page receives a ResultIntent
    @Override
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        super.onActivityResult(requestCode, resultCode, data);
        loadList();
//        if (requestCode == RequestCode.GET_CONTACT_ADD.ordinal()) {
//            if (data != null && data.hasExtra("Add_Contact")) {
//                Contact c = data.getParcelableExtra("Add_Contact");
//                loadList();
//            }
//        }
//
//        if (requestCode == RequestCode.GET_CONTACT_EDIT.ordinal()) {
//            if (data != null && data.hasExtra("Edit_Contact")) {
//                Contact c = data.getParcelableExtra("Edit_Contact");
//
//                loadList();
//            }
//        }
    ...
    //for the RecyclerView instance in the layout
                    ...
                    case DragEvent.ACTION_DROP:
                        ...
                        confirm.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                PhonebookDb.getInstance(context).contactDao().delete(deletingContact); //remove from PhonebookDB
                                loadList();
                                Toast.makeText(list_page.this, "DELETED!!!!", Toast.LENGTH_SHORT).show();
                            }
                        });
                        //Alert Box "NO"
                        confirm.setNegativeButton("NO", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Toast.makeText(list_page.this, "ITEM NOT DELETED!", Toast.LENGTH_SHORT).show();
                                dialogInterface.dismiss();
                            }
                        });
                        confirm.create();
    ...
    private void navBtnClick(int key) {
        //somehow, if key is out of bounds, just return back
        if (key < 0 || key > 26) {
            return;
        }

        //calc the offset based on the key
    ...
    private void setAllNavBtnClickListener() {
        //26 Buttons and their functions are created statistically
        //it doesn't look pretty
        //challenge yourself to create them dynamically!???
